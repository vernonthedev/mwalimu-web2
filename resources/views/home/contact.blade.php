...
@section('content')
    ...
    Breadcumb
============================== -->
<div class="breadcumb-wrapper " data-bg-src="https://fakeimg.pl/1200x600?text=Contact+Us">
        ...
        <div class="container">
            <div class="row flex-row-reverse gx-60 justify-content-between">
                <div class="col-xl-auto">
                    <img src="https://fakeimg.pl/589x681?text=Feel+Free" alt="Contact Mwalimu Junior School" class="w-100" style="border-radius: 20px;">
                </div>
